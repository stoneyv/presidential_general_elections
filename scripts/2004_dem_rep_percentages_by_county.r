...
results <- fread('../output/2004_pres_election_by_county.csv')
...
mdem <- ggplot(county_map_data,
        ...
        annotate("text", x = -105, y = 23, label = "data source:  National Atlas USGS 2004") +
        theme_minimal
...
ggsave(mdem2,
       ...
       height = 8.5,
       dpi = 300,
       file = "../plots/2004_dem_percentages_by_county.png",
       type = "cairo-png")       
...
ggsave(mrep2,
       ...
       height = 8.5,
       dpi = 300,
       file = "../plots/2004_rep_percentages_by_county.png",
       type = "cairo-png")       

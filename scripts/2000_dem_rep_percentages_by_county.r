...
# Load transformed results for 2000
results <- fread('../output/2000_pres_election_by_county.csv')
...
data_source <- "data source:  David Lublin and D. Stephen Voss. 2001./n\"Federal Elections Project.\"/n American University, Washington, DC and the University of Kentucky, Lexington, KY."
...
mdem <- ggplot(county_map_data,
        ...
        coord_map("polyconic") +
        labs(title = "US 2000 Presidential General Election\nDemocrat Vote Percentages by County") +
        annotate("text", x = -105, y = 23, label = data_source) +
        theme_minimal
...
ggsave(mdem2,
       ...
       height = 8.5,
       dpi = 300,
       file = "../plots/2000_dem_percentages_by_county.png",
       type = "cairo-png")       
...
ggsave(mrep2,
       ...
       height = 8.5,
       dpi = 300,
       file = "../plots/2000_rep_percentages_by_county.png",
       type = "cairo-png")       
